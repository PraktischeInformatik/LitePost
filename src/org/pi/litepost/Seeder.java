...
public class Seeder {
	...
	public static void seed() throws Exception{
		...
		dbQueryManager.executeQuery("insertPost", "Gamer PC DDDDD FFFFF 00000 1 x 109191000hz TKraft 73", "", LocalDateTime.of(2015, 2, 15, 8, 1), "Burgumstra�e 20", 4);
		dbQueryManager.executeQuery("insertPost", "Sch�rfe-Wettessen", "Beispiel-Text zur Demonstration des Forums.", LocalDateTime.of(2015, 2, 15, 17, 15), "I-wo beliebiges", 2);
